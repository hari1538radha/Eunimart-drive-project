...
const Detailpage = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#81FFEF] to-[#F067B4] flex flex-wrap items-center justify-center h-screen">
      <div>
        {
          <div className="flex flex-wrap items-center justify-center">
            {Loading === false && (
              <div id={data.id}>
                <div className=" mt-7 ml-14  flex flex-wrap  w-3/5 items-center justify-center bg-white border-2 border-slate-500 shadow-lg shadow-slate-600 h-[500px]">
                  <div>
                    <img
                      className=" hover:scale-105 duration-300 w-60 ml-4 h-60"
                      src={data.avatar}
                    ></img>
                  </div>
